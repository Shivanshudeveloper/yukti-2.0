<?php include './includes/header.inc.php' ?>
    <main>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 text-center">
                                <h2>Yukti 2.0 Startups Supported</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Hero End -->
        <!--? Blog Area Start-->
        <section style="padding-top: 10px;" class="blog_area section-padding">
            <div class="container">
                <div class="row">
                        ...
                        <div class="blog_left_sidebar">
                            <article class="blog_item">
                                ...
                                <div class="blog_details">
                                    ...
                                    <p>I and my team are really thankful to the Ministry of Education's Innovation Cell for helping us build our idea into a startup. The seed fund has helped us build a prototype and we are now looking for deploying the product in the real world.</p>
                                </div>
                            </article>
                        </div>
                    </div>
