...
<link rel="stylesheet" href="style.css">
    <main>
        ...
        <!--? Gallery Area Start -->
        <section class="p-4">
            <h1 class="font-weight-bold text-center">Register As</h1>
            <div class="row mt-5">
                <div class="col col-md">
                    <div class="card shadow">
                        <a href="forms/form1.php?t=s">
                        <div class="card-body">
                            <center>
                                <img src="https://img.icons8.com/color/80/000000/student-center.png"/>
                            </center>
                                <h5 class="card-title text-center mt-2">STUDENT</h5>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col col-md">
                    <div class="card shadow">
                        <a href="forms/form1.php?t=f">
                        <div class="card-body">
                            <center>
                                <img src="https://img.icons8.com/color/80/000000/female-teacher.png"/>
                            </center>
                                <h5 class="card-title text-center mt-2">FACULTY</h5>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col col-md">
                    <div class="card shadow">
                        <a href="forms/form1.php?t=i">
                        <div class="card-body">
                            <center>
                                <img src="https://img.icons8.com/officel/80/000000/university.png"/>
                            </center>
                                <h5 class="card-title text-center mt-2">INSTITUTE/INCUBATOR</h5>
                        </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="row mt-4">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <center>
                                ...
                                <h5 class="card-title text-center mt-2">MENTORS</h5>
                        </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <center>
                                ...
                                <h5 class="card-title text-center mt-2">INCUBATOR/ACCELERATOR</h5>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col col-md">
                    <div class="card shadow">
                        <a href="forms/form1.php?t=st">
                        <div class="card-body">
                            <center>
                                <img src="https://img.icons8.com/fluent/80/000000/company.png"/>
                            </center>
                                <h5 class="card-title text-center mt-2">STARTUPS</h5>
                        </div>
                        </a>
                    </div>
                </div>
        ...
        <section style="padding-top: 100px;" class="pb-5 container">
            ...
            <div class="slider owl-carousel">
                ...
                <div class="card">
                    <div class="img">
                        <img src="https://businessday.ng/wp-content/uploads/2016/03/Education-books.jpg" alt="">
                    </div>
                        <div class="content">
                            <div class="title">
                            Education
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial">
                                <div class="testimonial-caption">
                                    <p>"Hard work never brings fatigue. It brings satisfaction."</p>
                                    <div class="rattiong-caption">
                                        <span>- Sri. Narendra Modi,<span>PM India</span> </span>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Testimonial -->
                        ...
                        <div class="single-man-slider">
                            <div class="man-slider-active">
                                <div class="single-mam-img">
                                    <img src="https://m.hindustantimes.com/rf/image_size_960x540/HT/p2/2020/09/25/Pictures/prime-minister-narendra-modi-addresses-the-nation_cdcbd560-fea4-11ea-a5cd-623ad1e030ac.jpg" alt="">
                                </div>
                                <div class="single-mam-img">
