    ...
    <main class="mt-4 mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            ...
            <section class="sticky-top" style="top: 20px;">
              ...
              <section class="">
                <button data-toggle="modal" data-target="#exampleModal" class="btn mt-2 btn-block btn-lg btn-success">
                    Assign to Investors
                </button>
                <button data-toggle="modal" data-target="#exampleModal2" class="btn mt-2 btn-block btn-lg btn-info">
                    Assign to Mentors
                </button>
              </section>
      ...
      <div
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Investors List</h5>
                ...
                <div class="modal-body">
                    <?php 
                      $sql = "SELECT * FROM investor ORDER BY assign ASC;";
                      $result = mysqli_query($conn, $sql);
                      echo '
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="allocateInvestorBtn" class="btn btn-primary">Submit</button>
                </div>
                </form>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Mentors List</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <?php 
                      $sql = "SELECT * FROM mentor ORDER BY assign ASC;";
                      $result = mysqli_query($conn, $sql);
                      echo '
                        <input type="hidden" name="projectID" value="'.$projectID.'" />
                      ';
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="allocateMentorBtn" class="btn btn-primary">Submit</button>
                </div>
                </form>
                </div>
            </div>
