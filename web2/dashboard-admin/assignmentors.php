      ...
      <div class="container">
        ...
        <br />
          ...
          <?php
            ...
            // From Session
            $userId = '12345678';
            $sql = "SELECT * FROM allprojects WHERE mentors > 0;";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              if ($row2 = mysqli_fetch_assoc($result2)) {
                echo '
                  <div class="card mt-2">
                    <div class="card-body">
                      <span class="badge bg-danger float-right h5">Mentors: '.$mentors.'</span>
                      <h5 class="card-title">'.$row2['name_product'].'</h5>
                      <p class="card-text">
                        '.$row2['innovation_address'].'
                      </p>
                      <a href="mentorsunderevaluationinfo.php?id='.$projectID.'" class="btn btn-primary float-right">Read</a>
                    </div>
                  </div>
                ';
              }
