<?php include '../../includes/header.inc.php' ?>
    <main class="mt-4 mb-5 container">
        ...
        <div class="row mt-4">
            <div class="col col-lg-3">
                <h5>Availability per week for mentoring (Hours a week)</h5>
            </div>
            <div class="col">
                <select class="form-select" aria-label="Default select example">
                    <option selected>-- SELECT YOUR OPTIONS --</option>
        ...
        <div class="row mt-4">
            <div class="col">
                <h5>Will prefer to mentor on- Days of week (Monday - Friday)</h5>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col">
                <h5>Will prefer to mentor on Weekend (Saturday & Sunday)</h5>
            </div>
        </div>
        ...
        <div class="col mt-4">
            <h5>Preferred Mode of Communication for mentorship</h5>
        </div>
        <div class="row mt-2">
            <div class="col">
                <div class="form-check">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="flexCheckChecked">
                        Phone (Registered Phone will be used)
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked2" >
                    <label class="form-check-label" for="flexCheckChecked2">
                        Emails (Registered Email will be used)
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col col-lg-3">
                <h5>If Online: Please give your SkypeID, Google Meet, other</h5>
            </div>
            <div class="col">
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col">
                <a href="form2.php" class="btn btn-block btn-lg btn-success">
                    Submit
                </a>
            </div>
        </div>
