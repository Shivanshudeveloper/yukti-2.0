            ...
            <div class="slider-active">
                ...
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                          <div class="hero__img">
                            <img src="./images/startup.jpg" alt=""  data-animation="fadeInRight" data-transition-duration="5s">
                          </div>
                          <div class="hero__caption">
                              <h1 data-animation="fadeInLeft" data-delay=".4s">YUKTI 2.0 <br>MHRD Innovation Cell</h1>
                              <p data-animation="fadeInLeft" data-delay=".6s">Log in now with your YUKTI 2.0 Account to submit your technology and innovation to us. If you don’t already have an account, creating one is easy</p>
                              <!-- Hero Btn -->
                              <a href="register.php" class="hero-btn"  data-animation="fadeInLeft" data-delay=".9s" >
                                  Register Today
                                  <!-- Arrow SVG icon -->
                ...
                <div class="row align-items-end">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="wantToWork-caption">
                            ...
                            <h2>Get Connected with Top Investors in India</h2>
                        </div>
                    </div>
                </div>
            </div>
