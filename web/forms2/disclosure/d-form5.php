...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
                ...
                <div class="row align-items-end">
                    <div class="col">
                        <div class="wantToWork-caption">
                            ...
                            <h2>
                                Other Important Details of Innovation/ Technology 
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <!-- Want To Work End -->
        <!-- Our Services Start -->
        <div class="our-services container pt-25">
            ...
            <div class="row mt-4">
                <div class="col ml-4">
                    <a href='../other/o-form1.php' class="genric-btn primary w-50">
                        Next
                    </a>
                </div>
            </div>
        ...
        <!-- David Droga End -->
        <!-- Want To Work Start -->
        <div class="wantToWork-area wantToWork-area2 w-padding2" style="margin-top: 10%;">
            <div class="container">
