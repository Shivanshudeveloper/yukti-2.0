...
<section class="mt-4 container mb-5">
    ...
    <div class="row mt-2">
        <div class="col">
            <div class="form-check">
                <textarea class="form-control" name="describeSegement" id="describeSegement" rows="50"></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-2">
        <div class="col">
            <div class="form-check">
                <textarea class="form-control" name="uniqueSelling" id="uniqueSelling" rows="50"></textarea>
            </div>
        </div>
    </div>
...
<script>
    CKEDITOR.replace('describeSegement', {
        height: 300
    });
    CKEDITOR.replace('uniqueSelling', {
        height: 300
    });
</script>
